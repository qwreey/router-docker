  ...
  return (
    <section>
      ...
      <p className="section-description">
        code-docker/dind가 내보내는 트래픽에 대한 CIDR allow/block 규칙과, 호스트 포트를
        code-docker-internal의 컨테이너로 전달하는 포트포워딩을 관리합니다.
      </p>
      <div className="warning-note">
        <span aria-hidden="true">⚠</span>
        <span>
          <strong>
            code-docker-internal에 직접 붙어 있는 컨테이너끼리(code-docker↔dind, code-docker↔router)의 트래픽은 이
            테이블로 제어할 수 없습니다.
          </strong>{' '}
          ...
          규칙으로 dind나 다른 code-docker-internal 컨테이너로의 접근을 막을 수는 없고, 오직 code-docker-external을
          거쳐 나가는(외부/인터넷 방향) 트래픽만 이 규칙의 적용을 받습니다.
        </span>
      </div>
